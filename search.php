...
<div class="searchContainer">
    ...
    <input type="text" class="searchInput" value="<?php echo $term; ?>" placeholder="Start typing..." spellcheck="false">
</div>
...
<div class="trackListContainer borderBottom">
    <h2 class="centerHeading">SONGS</h2>
    <ul class="trackList">
        ...
        if(mysqli_num_rows($songsQuery) == 0){
            echo "<span class='noResult'> No songs were found matching '" . $term ."'</span>";
        }
...
<div class="artistsContainer borderBottom">
   <h2 class="centerHeading">ARTISTS</h2>
   
   <?php
    $artistsQuery = mysqli_query($con, "SELECT id FROM artists WHERE name LIKE '%$term%'");
    
    if(mysqli_num_rows($artistsQuery) == 0){
            echo "<span class='noResult'> No artists were found matching '" . $term ."'</span>";
        }
    $i = 1;
    while($row = mysqli_fetch_array($artistsQuery)){
        $artistFound = new Artist($con, $row['id']);
        
        echo "<div class='searchResultRow' onclick='openPage(\"artist.php?id=" . $artistFound->getId() . "\")'>
                <div class='trackCount'>
                <span class='trackNumber'>$i</span>
                </div>
...
<div class="gridViewContainer">
    ...
    if(mysqli_num_rows($albumQuery) == 0){
            echo "<span class='noResult'> No albums were found matching '" . $term ."'</span>";
        }
